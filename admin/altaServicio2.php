...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['actualizar'])) {
    ...
    //$idUsuario=$_SESSION['login']['idUsuario'];
    $idUsuario=1;
$idServicio=updateServicio($_POST['txtNomEvt'], $_POST['selCategoria'],  $_POST['txtDescripcion'],  $_POST['txtDescripcionCorta'],  $_POST['txtDocumentacionViajero'],  $_POST['txtObservaciones'],  $_POST['idTextoMiniatura'],$idUsuario, $_POST['idOrigen'],$_POST['idDestino'],$_POST['idServicio'] );
