...
$idServicioSalidas=$_POST['idServicioSalidas'];
$idServiciosSalidasPack=$_POST['idServiciosSalidasPack'];
...
$accesibilidad=$_POST['accesibilidad'];
  	...
  	$idServicioSalidasResu=  updateSalidasPack($idServiciosSalidasPack, $nombre_periodo,$fechaSalida, $horaSalida, $horaCheckIn, $horasAnticipacion, $duracionMinima, $duracionMaxima,$cantLugares, $nota_salida, $accesibilidad);



}

if ($idServicioSalidasResu) {

    alertar("atualizado com sucesso","success");
...
<div class="content-wrapper">
  ...
  <input type="hidden" name="idServiciosSalidasPack" value="<?=$idServiciosSalidasPack;?>">
...
<div class="col-md-12">
    ...
    <tr>
                    ...
                    <td><?=$comisiona;?></td>
                    <td>
                        <a href="tarifasEditorXPack?idServicioSalidasTarifas=<?=$idServicioSalidasTarifas;?>" class="btn-sm btn-info">Editar</a>
