  ...
  <table class="table" id="tablaCarrito">
    <thead>
      <tr>
                    ...
                    <th scope="col">Cupon de Desconto</th>
                    ...
                    <th scope="col">Ganancia do Sistema (final com desconto si tiver)</th>
                    <th scope="col">Ganancia Sistema + Comissão Vendedor</th>
                    <th scope="col">Desconto Mercado Pago e Outros gastos Admin</th>
                    <th scope="col">Ganancia Sistema Final (descontando Passarelas de Pagamentos e outros impostos) (O que fica no bolso) </th>
