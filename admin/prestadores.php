...
for($i=0;$i < count($prestadores); $i++){
 ...
 $usuario=getUsuario($idUsuario);
  ...
  <tr> 
   ...
   <td><form method="post" action="altaPrestador">
              <button name="editaPrestador" value="<?=$idPrestador;?>" type="submit" class="btn btn-success">Editar</button>
        </form>
              <a class="btn-sm btn-danger"onclick="borraPrestador('<?=$idPrestador;?>')"> Eliminar</a>
    </td>
