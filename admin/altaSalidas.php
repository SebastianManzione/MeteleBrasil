...
$idComisionPrestador = null;
if (isset($_POST["selComisionPrestador"])) {
   $idComisionPrestador = $_POST["selComisionPrestador"];
}
...
if ($insert) {
    ...
    $nota_salida_en = $_POST["nota_salida_en"];
    $nota_salida_pt = $_POST["nota_salida_pt"];
    $nota_salida_it = $_POST["nota_salida_it"];
...
$sinHorarioTexto=$_POST["sinHorarioTexto"];
    ...
    $idServicioSalidas = altaSalida($nombre_periodo, $idServicio, $fechaSalida,
      $hSalida, $horaCheckIn, $horasAnticipacion, $duracionMinima, $duracionMaxima,
      $cantLugares, $accesibilidad, $prestador, $idPackSalidas, $idMoneda, $nota_salida,
      $nota_salida_en, $nota_salida_pt, $nota_salida_it, $sinHorario, $sinHorarioTexto, $idComisionPrestador);
...
body {
  ...
  padding: 0;
    ...
    <!--
     ...
     with https://www.npmjs.com/package/@googlemaps/js-api-loader. AIzaSyBEshzf3yb1ZWmvpGJSskvgCMYGbkiRIPw
...
<?php for ($i=0; $i < count($prestadores); $i++) { ?>
 ...
 <option value="<?=$prestadores[$i]["idPrestador"];?>"><?=$prestadores[$i]["nombre"];?></option>
...
<?php
                                        ...
                                        <label class="label label-default mt-2">Comisión del Prestador</label>
...
<input type="checkbox" name="sinHorario" > <?=$lang['ativar_salidas_texto'];?>
                              ...
                              <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="label-default "><?=$lang["nota_de_salida"];?></label>
                                          ...
                                          <div class="col-12">
                                         <div class="form-group">
                                                  <label class="label-default"><?=$lang["nota_de_salida"];?> (ES)</label>
                                          ...
                                          <div class="col-12">
                                              <div class="form-group">
                                                  <label class="label-default"><?=$lang["nota_de_salida"];?> (EN)</label>
                                                  <textarea name="nota_salida_en" class="form-control select2bs4" style="width: 100%;" placeholder="<?=$lang['escriba_detalles_y_topicos'];?>"></textarea>
                                              </div>
                                          </div>

                                          <div class="col-12">
                                              <div class="form-group">
                                                  <label class="label-default"><?=$lang["nota_de_salida"];?> (PT)</label>
                                                  <textarea name="nota_salida_pt" class="form-control select2bs4" style="width: 100%;" placeholder="<?=$lang['escriba_detalles_y_topicos'];?>"></textarea>
                                              </div>
                                          </div>

                                          <div class="col-12">
                                              <div class="form-group">
                                                  <label class="label-default"><?=$lang["nota_de_salida"];?> (IT)</label>
                                                  <textarea name="nota_salida_it" class="form-control select2bs4" style="width: 100%;" placeholder="<?=$lang['escriba_detalles_y_topicos'];?>"></textarea>
                                              </div>
                                      ...
                                      ?><option value="<?=$edades[$i]['idEdad'];?>" <?=$selected?> ><?=$edades[$i]['valor'];?></option><?php
                                                        ...
                                                        <div class="form-group col-auto ">
                                                            ...
                                                            <select id="tipo_tarifa">
                                                              ...
                                                              <?php
                                                              $tarifas = getTiposTarifas();
                                                              foreach ($tarifas as $tarifa) {
                                                                if ($tarifa['idTipoTarifa'] == 2 || $tarifa['idTipoTarifa'] == 4) { ?>
                                                                  <option value="<?= $tarifa['idTipoTarifa']; ?>"><?= $tarifa['nombre']; ?></option>
                                                                <?php }
                                                              } ?>
                                                            </select>
                                        ...
                                        ?>
                                                          ...
                                                          <td >
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <button type="button" class="btn btn-success" onclick="addPax(); return false;">+</button>
...
<script type="text/javascript">
	...
	// Función para actualizar comisiones cuando cambia el prestador
