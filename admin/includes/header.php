...
if ($host=="server") {
 $GLOBALS["path"]=$_SERVER['DOCUMENT_ROOT']."/reservate/admin";
}
else{
$GLOBALS["path"]=$_SERVER['DOCUMENT_ROOT']."/admin";
...
<script src="js/dataTables.bootstrap4.min.js" type="text/javascript" charset="utf-8" async defer>
</script>
