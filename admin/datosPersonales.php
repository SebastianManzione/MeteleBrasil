                ...
                <h5><?=$lang["responsable_de_la_reserva"]?></h5>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="email" class="form-control" placeholder="Email" name="txtEmailResponsable" required>
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="custom-control custom-checkbox mr-sm-2">
                    ...
                    <label class="custom-control-label" for="customControlAutosizing"><?=$lang["acepto_las"];?><a href="privacy" target="_BLANK"><?=$lang["politicas"]?></a> <a data-toggle="modal" data-target="#politicas"><i class="fa fa-exclamation-circle"></i></a><?=$lang["y_las_condiciones_generales"]?> </label>
