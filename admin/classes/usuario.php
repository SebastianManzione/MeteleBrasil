...
function getUsuarios(){
    ...
    $consulta = "select * from usuario WHERE idVendedor>0";
   $comando = $pdo->prepare($consulta);
    $comando->execute();
    $cuenta_col = $comando->columnCount();
    $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
    ...
    function getUsuariosCobradores(){

    require("conexion.php");
    
    
    $consulta = "select * from usuario WHERE idCobrador>0";
   $comando = $pdo->prepare($consulta);
    $comando->execute();
    $cuenta_col = $comando->columnCount();
    $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
    ...
    function getUsuariosPrestadores(){

    require("conexion.php");
    
    
    $consulta = "select * from usuario WHERE idPrestador>0";
   $comando = $pdo->prepare($consulta);
    $comando->execute();
    $cuenta_col = $comando->columnCount();
    $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
