<?php
function getTextosViajeros(){

    require("conexion.php");
  
    $consulta = "select * from texto_viajeros";
    ...
    function getTextoViajeros($idTextoViajeros){

    require("conexion.php");
    $data=["idTextoViajeros"=>$idTextoViajeros];
    $consulta = "select * from texto_viajeros WHERE idTextoViajeros=:idTextoViajeros";
