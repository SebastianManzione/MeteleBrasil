<?php function getCuerpoEmailReservaPendiente($codigoAmigable){
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;">
                                  Sua reserva metelebrasil.com foi realizada! Em breve enviaremos um email de confirmação da reserva quando o seu pagamento for processado com sucesso.
                                </div>
                              </td>
                            </tr>
                          </table>
