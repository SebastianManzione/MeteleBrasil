<?php
function getTiposEdad(){

    require("conexion.php");
  
    $consulta = "select * from tipos_edad";
    ...
    function getTipoEdad($idTipoEdad){

    require("conexion.php");
    $data=["idTipoEdad"=>$idTipoEdad];
    $consulta = "select * from tipos_edad WHERE idTipoEdad=:idTipoEdad";
