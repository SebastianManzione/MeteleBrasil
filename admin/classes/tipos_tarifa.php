<?php
function getTiposTarifas(){

    require("conexion.php");
  
    $consulta = "select * from tipos_tarifa";
    ...
    function getTipoTarifa($idTipoTarifa){

    require("conexion.php");
    $data=["idTipoTarifa"=>$idTipoTarifa];
    $consulta = "select * from tipos_tarifa WHERE idTipoTarifa=:idTipoTarifa";
