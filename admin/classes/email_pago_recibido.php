                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                 Gracias por abonar ".$total_abonado." para el numero de reserva ".$codigo_amigable." mediante ".$pasarela.". 
                                </div>
                              </td>
                            </tr>
                          </table>
          ...
          <tbody>
            <tr>
              ...
              <div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                        ...
                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                          <tr>
                            <td align='center' bgcolor='#029ce2' role='presentation' style='background-color:#029ce2;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                              <a href='metelebrasil.com/consultaReserva?reserva=".$codigo_amigable."' style='background:#029ce2;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                               Ver online
                              </a>
                  ...
                  Si no funciona el link copie y pegue en su navegador<br>
                              metelebrasil.com/consultaReserva?reserva=".$codigo_amigable."
                </div>
