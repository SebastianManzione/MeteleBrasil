  ...
  var clndrTemplate =
    "<div class='clndr-controls'>" +
        "<div class='clndr-control-button'>" +
            "    <span class='clndr-previous-button'><i class='fas fa-arrow-circle-left fa-2x'></i></span>" +
        '</div>' +
        "<div class='month'><%= month %> <%= year %></div>" +
        "<div class='clndr-control-button rightalign'>" +
            "<span class='clndr-next-button'><i class='fas fa-arrow-circle-right fa-2x'></i></span>" +
        '</div>' +
    '</div>' +
