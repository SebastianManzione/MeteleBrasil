...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST["texto_miniatura"])) {
    $textos_miniaturas=$_POST["texto_miniatura"];
    $resu=setTextoMiniatura($textos_miniaturas);
    if ($resu>1) {
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-header">
               ...
               <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#exampleModal" data-whatever="agregarNota">Agregar nuevo texto miniaturas
</button>          
...
<p>
                                              <input class="form-control" type="text" name="texto_miniatura">
        ...
        <button type="button" class= "btn btn-secondary btn-lg btn-block" data-card-widget="collapse">Lista de textos miniaturas</button>
...
<button type="submit" name="eliminarTextoMiniaturas" value="<?=$idTextoMiniaturas;?>" class="btn-sm btn-warning">Eliminar</button></form>
