...
fwrite($fp, json_encode($bodyArray).PHP_EOL);


$event_type=$bodyArray["event_type"];
$id=$bodyArray["id"];
$custom_id=$bodyArray["resource"]["purchase_units"][0]["custom_id"];
$create_time=$bodyArray["create_time"];
$summary=$bodyArray["summary"];
$currency_code=$bodyArray["resource"]["amount"]["currency_code"];
$value=$bodyArray["resource"]["purchase_units"][0]["amount"]["value"];
fwrite($fp,"Este seria el tipo de event".$bodyArray["event_type"]);
if ( $event_type=="CHECKOUT.ORDER.APPROVED") {

fwrite($fp,"Resultado del pago".InsertaPago($custom_id,$value,4, 188,$id));
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                 Gracias por abonar USD ".$value." para el numero de reserva ".$custom_id." mediante Paypal. 
                                </div>
                              </td>
                            </tr>
                          </table>
                        ...
                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                          <tr>
                            <td align='center' bgcolor='#029ce2' role='presentation' style='background-color:#029ce2;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                              <a href='metelebrasil.com/sistema/metelebrasil/consultaReserva.php?id=".$custom_id."' style='background:#029ce2;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                               Ver online
                              </a>
                            </td>
                          </tr>
