              ...
              <table class="table table-striped table-hover table-bordered">
                  ...
                  ?>
                              <tr>
                                  ...
                                  <td rowspan="<?= $num_pasajeros ?>" class="align-middle text-center"><?= date("d-m-Y H:i", strtotime($reserva['detalles']['fechaAlta'])); ?></td>                                                             <td rowspan="<?= $num_pasajeros ?>" class="align-middle text-center font-weight-bold"><?= htmlspecialchars($_SESSION["moneda_sel_sym"]) . number_format($reserva['detalles']['total_dolares'], 2, ',', '.') ?></td>                                                                                                  <?php } ?>
                              </tr>
                  <?php
                          }
                      }
        ...
        <section class="<?= ($isPrestador || $isAdmin) ? 'col-lg-6' : 'col-lg-12' ?> connectedSortable">
          ...
          <div class="card card-success">
            ...
            <div class="card-body">
              ...
              <div class="mt-3">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="filtrarPasajerosVendedor" <?= !isset($_GET['filtroVendedor']) || $_GET['filtroVendedor'] != '1' ? 'checked' : '' ?> onchange="
                    let isChecked = document.getElementById('filtrarPasajerosVendedor').checked;
                    document.getElementById('inputFiltroVendedor').value = isChecked ? '' : '1';
                    document.getElementById('formFiltrosVendedor').submit();
                  ">
                ...
                <form id="formFiltrosVendedor" method="get" style="display:none;">
                  ...
                  <input type="hidden" id="inputFiltroVendedor" name="filtroVendedor" value="">>
                </form>
              </div>
            </div>
          </div>
