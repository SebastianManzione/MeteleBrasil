...
$permisos->verificarAcceso('edades');
...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
  print_r($_POST);
  if (isset($_POST["addEdad"])) {
    $edad=$_POST["edad"];
    $resuEdad=setEdad($edad);

    if ($resuEdad>0) {
  alertar("Edad Guardada con éxito","success");
}
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">edades</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Administración</a></li>
              <li class="breadcrumb-item active">edades</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#exampleModal" data-whatever="agregarNota">Agregar edad</button>          
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <button type="submit" name="addEdad" class= "btn btn-primary">Agregar</button>
                                            </form>
                                          </div>
...
for ($i=0; $i < count($edades); $i++) { 
  $idEdad=$edades[$i]["idEdad"]
?>



                             <tr>
                                <td data-order="<?=$edades[$i]["valor"]?>"><?=$edades[$i]["valor"]?></td>
