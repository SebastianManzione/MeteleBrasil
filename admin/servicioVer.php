...
for ($i=0; $i <  count($fotos); $i++) { 
 ...
 <?php
        ...
        <div class="col-12 form-inline">
         ...
         <form method="post" action="servicioOpiniones"><button name="idServicio" value="<?=$idServicio;?>" class="btn btn-success">Opiniones</button></form>
          <form><button class="btn btn-danger">Eliminar servicio</button></form>
      </div>     
      </div>  <!-- /.card. -->
