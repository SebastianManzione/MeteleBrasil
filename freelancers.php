...
// $linkRegistro = 'registroFreelancers'; // Original
$linkRegistro = 'https://docs.google.com/forms/d/1SOhr088SB57aXOT-if-IDxblnC2AThLj5k82AtYfn6Q/viewform?edit_requested=true'; // Temporal
              ...
              <div class="row" >
                <div class="col">
                 <h1><span class="blue">1</span></h1>
                  ...
                  <h3 class="texto-bottom" style="margin-top: 20px;"><?=$lang["completa_datos_freelance"];?></h3>
                </div>
                <div class="col">
                  <h1><span class="blue">2</span></h1>
                 <h3 class="texto-bottom" style="margin-top: 20px;"><?=$lang["activaremos_tu_cuenta_agencia"];?></h3>
                </div>
                <div class="col">
                  <h1><span class="blue">3</span></h1>
                  <h3 class="texto-bottom" style="margin-top: 20px;"><?=$lang["comience_a_ofrecer"];?>Comience a ganar comisión</h3>
                </div>

              </div>
              <br><br><br><br>

 <a class="btn btn-reservar-calendar btn-lg h-90" style="background-color:#FEFF00;" target="_blank" href="<?php echo $linkRegistro; ?>" ><b><?=$lang["activar_agencia"];?></b></a>
              ...
              <div class="row">
                <div class="col-sm-3">
                 <i class="fas fa-piggy-bank fa-3x  text-primary"></i><br>
                  ...
                  <p class="texto"  style="margin-top: 20px;">><?=$lang["genera_nuevos_ingresos"];?></p>
                </div>
                <div class="col-sm-3">
                  <i class="fas fa-chalkboard-teacher fa-3x text-primary"></i>
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["facil_intuitivo"];?></h5>
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["disponibilizamos_nuestra_plataforma"];?></p>
                </div>
                <div class="col-sm-3">
                  <i class="fas fa-user-plus fa-3x text-primary"></i>
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["se_parte_del_turismo"];?></h5>
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["ofrezca_para_turistas"];?></p>
                </div>
                <div class="col-sm-3">
                  <i class="fas fa-user-shield fa-3x text-primary"></i>
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["gane_reconocimiento"];?></h5>
                   <p class="texto"  style="margin-top: 20px;"><?=$lang["ofrezca_servicios_destacados"];?></p>
                </div>
              </div>
...
<i class="fas fa-street-view fa-3x text-primary"></i>
                ...
                <div class="col-sm-3">
                  ...
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["tiene_la_posibilidad_administrar_comisiones"];?></p>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                 <i class="fas fa-funnel-dollar fa-3x  text-primary"></i>
                  ...
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["reciba_sus_comisiones"];?></p>
                </div>
                <div class="col-sm-3">
                  ...
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["ofreceles_diferentes_monedas"];?></p>
                </div>
                <div class="col-sm-3">
                  <i class="fas fa-people-arrows"></i>
                  <i class="fas fa-tachometer-alt fa-3x text-primary"></i>
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["mejora_tu_confianza_"];?></h5>
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["genere_reservas_sin_filas"];?></p>
                </div>
                <div class="col-sm-3">
