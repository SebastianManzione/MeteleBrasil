...
// $linkRegistro = 'registroAgencias'; // Original
...
<h1 class="text-white text-uppercase titulo" style='text-align:center'>
                                  ...
                                  <?=$lang["sumale_clientes_agencia"];?></h1>
              ...
              <div class="row" >
                <div class="col">
                 <h1><span class="blue">1</span></h1>
                  ...
                  <h3 class="texto-bottom" style="margin-top: 20px;"><?=$lang["completa_agencia"];?></h3>
                </div>
                <div class="col">
                ...
                <div class="col">
                  ...
                  <h3 class="texto-bottom" style="margin-top: 20px;"><?=$lang["comienza_a_recibir_reservas"];?></h3>
                </div>
         ...
         <div class="col-lg-12 text-center">
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["genera_mas_reservas_agencia"];?></p>
                </div>
                <div class="col-sm-3">
                  <i class="fas fa-user-plus fa-3x text-primary"></i>
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["1_prestador_por_servicio"];?></h5>
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["somos_democraticos"];?></p>
                </div>
                <div class="col-sm-3">
                  <i class="fas fa-user-shield fa-3x text-primary"></i>
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["valoramos_cada_agencia"];?></h5>
                   <p class="texto"  style="margin-top: 20px;"><?=$lang["acompanamos_cada_agencia"];?></p>
                </div>
              </div>
         ...
         <div class="col-lg-12 text-center">
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <h5 class="texto"  style="margin-top: 20px;"><?=$lang["agiliza_tu_logistica"];?></h5>
                  <p class="texto"  style="margin-top: 20px;"><?=$lang["mejora_la_confianza"];?></p>
                </div>
                <div class="col-sm-3">
