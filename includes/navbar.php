...
$precioTotalCarrito+=($tarifa[0]["valor"] ?? 0);
 ...
 <!--MENU MOVIL-->
  <section class="bg-celeste ptb-10 d-lg-none" style="background-color: #0099cc !important;">
 	<div class="container">
 		<div class="row">
 		    <div class="col-1">
      ...
      <div class="col-4 text-left" >
          <a style="margin-right: 2px;margin-left: 2px;" class="navbar-brand navbar-movil  " href="index"><h5 class="mb-0 text-white" style="font-size: 28px; font-weight: 700; white-space: nowrap; text-shadow: 1px 1px 2px rgba(0,0,0,0.3);">METELE BRASIL</h5> </a>
      </div>
