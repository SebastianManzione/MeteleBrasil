...
// Dev diagnostics only in local env
if (getenv('APP_ENV') === 'dev') {
    error_reporting(E_ALL);
    ini_set('display_errors', 1);
    ini_set('log_errors', 1);
    ini_set('error_log', __DIR__ . '/../dev_error.log');
}
...
if (!isset($_SESSION['idioma'])) {
    ...
    $idiomaDetectado = $_SESSION['geoFinal']['lang'] ?? 'ES';
    $_SESSION["idioma"] = $idiomaDetectado;
    $_SESSION["idioma_bandera"] = $banderasPorIdioma[$idiomaDetectado] ?? 'img/countries/Spain-icon.png';
}
...
<nav class="navbar navbar-expand-lg bg-celeste text-uppercase  d-none d-lg-block" id="mainNav">
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1 dropdown" translate="no">
            ...
            <!-- NOTA: Las funciones cambiaMoneda y cambiaIdioma ahora están en js/navbar-functions.js -->
            ...
            <li class="nav-item mx-0 mx-lg-1 dropdown">
                ...
                <div class="dropdown-menu menu-civa" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    if (isset($carrito) && is_array($carrito) && count($carrito) > 0) {
    ...
    <div class="container">
        ...
        <div class="row">
           ...
           <div class="col-1">
                ...
                <a class="cursor" id="abrir-menu" data-toggle="collapse" data-target="#menu-mobile" aria-expanded="false" aria-controls="menu-mobile">
                ...
                <a class="cursor collapse text-white" id="cerrar-menu" data-toggle="collapse" data-target="#menu-mobile" aria-expanded="false" aria-controls="menu-mobile">X</a>
...
<div id="menu-mobile" class="collapse navbar-collapse menu-mobile">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item mx-0 mx-lg-1 user">
            ...
            <div id="usuario-movil" class="collapse">
