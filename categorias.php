        ...
        <!--BUCLE DE RESULTADOS -->
          ...
          <div class="col-4 ">
           ...
           <div class="col-8 my-auto">
            ...
            <p class="text-left text-filtrar" ><?= $cantidad_servicios_categoria;?> actividades en <?= $nombre_categoria; ?></p>
          </div>
        </div>
        </div>

 <p class="text-left d-md-block d-none " style="font-size: 30px;"><?= $cantidad_servicios_categoria;?> actividades en <?= $nombre_categoria; ?></p>
