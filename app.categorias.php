...
<body>
  ...
  <section class="controles-busqueda">
    <div class="container">
        <form class="form-buscar mb-2" action="app.partners01.php" method="get">
          ...
          <div class="btn-group-vertical d-flex mb-4 w-100">
             <?php
                ...
                foreach ($todas_las_categorias as $cat) {
                    ...
                    echo '<a href="app.partners01.php?idCategoria=' . $cat["idCategoria_servicio"] . '" class="btn btn-outline-primary ' . $isActive . '">' . $cat["nombre_categoria_servicio"] . '</a>';
                }
             ?>
          </div>
