...
<!-- BOTON AYUDA-
  ...
  <?php if (!isset($_COOKIE['politicaCookies'])){?>
     <div class="cookies" id="cookies">
          ...
          <div class="container">
             <div class="row">
               <div class="col-8"><p class="text-white mb-0 text-justify cookies-sm " style="font-size:14px;">Utilizamos cookies propias y terceros para mejorar su experiencia según sus hábitos de navegación. Si continua navegando, consideramos que acepta su uso. Encontraras más información en nuestra <a href="cookies.php">política de cookies</a> 
               </p> 
              </div>
