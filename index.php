...
SELECT s.idServicio, s.nombre_servicio, s.destacado, u.latitud, u.longitud

FROM servicio s

LEFT JOIN servicio_tarifas_ubicacion u ON s.idServicio = u.idServicioSalidasTarifas
         ...
         <a href="servicio.php?id=<?=$idServicio;?>"class="destacados">
             ...
             <div class="card-body card-body-10">
               ...
               <div class="row" style="position:relative">
                 ...
                 <h5 ><?=$servicios_restantes[$i]["nombre_servicio"];?></h5>
