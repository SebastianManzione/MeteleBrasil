...
if ($_SERVER["REQUEST_METHOD"] == "POST"  ) {
    // Validación anti-bot
    $validacion = validarAntiBot('register_operator_form', $_POST['recaptcha_token'] ?? null);
      ...
      <div class="col-lg-12">
        ...
        <div class="badge badge-primary badge-ciudad"></div>
         <!--FIN BUCLE DE LOS RESULTADOS AQUI-->
          ...
          <!--TITULO-->
        <h1 class="text-white texto-shadow py-2 bold" style=" text-shadow: -1px 0px 6px #000000; text-align:center;"><?=$lang["registre_prestador"];?></h1>
         <!--TITULO-->
...
<h5 class="a-title-empleo afiliados" style="text-align: center;"><?=$lang["completa_datos_para_activar_prestador"];?></h5>
...
<div class="card-body register-card-body">
      <p class="login-box-msg"> <?=$lang["crie_un_usuario_registro"];?></p>
...
<div class="card card-primary" style="margin-left: 5%;margin-right: 5%;">
              <div class="card-header">
                ...
                <h3 class="card-title"><i class="fas fa-briefcase"></i> <?=$lang["datos_de_la_empresa"];?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1"><?=$lang["nombre_prestador"];?></label>
                    <input type="name" class="form-control" id="nombre_prestador" name="nombre_agencia" placeholder="<?=$lang["complete_nombre_fantasia_empresa"];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["tipo_de_prestador"];?></label>
                    <input type="name" class="form-control" id="tipo_de_prestador" placeholder="<?=$lang["cuentanos_tu_empresa"];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["prestador_destaque"];?></label>
                    <input type="text" class="form-control" id="prestador_descripcion" name="tipo_agencia" placeholder="<?=$lang["prestador_descripcion"];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["nombre_"];?></label>
                    <input type="name" class="form-control" id="nombre_" name="nombre" placeholder="<?=$lang["complete_con_su_nombre"];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["cargo_empresa"];?></label>
                    <input type="name" class="form-control" id="cargo_empresa" name="cargo_empresa" placeholder="<?=$lang["indique_cargo_en_empresa_"];?>">
                  </div>
                    <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["servicio_que_desea_ofrecer"];?></label>
                    <input type="name" class="form-control" name="descripcion" placeholder="<?=$lang["indique_servicio_ofrecer"];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["whatsapp_"];?></label>
                    <input type="tel" class="form-control" id="whatsapp_" name="whatsapp" placeholder="<?=$lang["indique_whatsapp_empresa"];?>">
                  </div>
...
<div class="row">
          <div class="col">
            <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="estado_" name="estado" placeholder="<?=$lang["indique_estado_"];?>">
          </div>
          </div>
           <div class="col">
            <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["ciudad_"];?></label>
                    <input type="name" class="form-control" id="ciudad_" name="ciudad" placeholder="<?=$lang["indique_ciudad_"];?>">
          </div>
           ...
           <div class="col">
            <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="destino_que_opera" name="destino_que_opera" placeholder="<?=$lang["indique_destino_que_opera"];?>">
