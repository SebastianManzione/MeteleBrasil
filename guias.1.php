...
?>
       ...
       <div class="col-lg-4 col-md-6 col-12 mb-4">
         ...
         <a data-toggle="modal" data-target="#exampleModal" data-whatever="agregarNota" class="imagen">
...
<!--EMPIEZA SECCION Actividades destacadas-->
 <section class="">
   <div class="container">
     <div class="row mb-4">
       <div class="col-lg-12 ">
         <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0 "><?=$lang["guias_de_actividades_ciudades"]?></h2>
       </div>
     </div>
     <div class="row ">
                   ...
                   <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal" data-whatever="agregarNota"><?=$lang["quiero_comentar"];?></button>
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel"><?=$lang["enviamos_tu_pdf"];?></h5>
                                          ...
                                          <div class="modal-body">
                                            <form method="post">
                                              <div class="form-group">
                                               ...
                                               <input type="hidden" name="idServicio" value="<?=$idServicio;?>">
                                                  <label for="recipient-name" class="col-form-label"><?=$lang["nombre_apellido"];?>:</label>
                                            ...
                                            <div class="form-group">
                                            <button type="submit" name="setOpinionServicio" class= "btn btn-primary"><?=$lang["enviar_pdf"];?></button>
                                          </div>
