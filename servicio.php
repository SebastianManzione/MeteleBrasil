    ...
    //********************fin fotos*******************************************?>
      ...
      <!--TEXTO IMPORTANTE-->
       ...
       <?=$servicio["observaciones"];?>
        ...
        <p>Opcionalmente, podes reservar la recogida en por el hotel. La recogida es una hora antes de la hora de inicio del tour e incluye todos los alojamientos en un radio de 8 kilÃ³metros desde el punto de encuentro.</p>
        ...
        <!--FIN CONTENEDOR DETALLES-->
          ...
          <div class="col-lg-4">
               ...
               <div class="div-precios text-right d-md-block d-none">
                     ...
                     <h4 style="font-size: 20px; color: #ff0000; font-weight: bold;"> 
                    ...
                    <h4 style="font-size: 20px; color: #008000; font-weight: bold;"> 

                     Ahora</h4><h2 class="text-primary" style="font-size:10px;"><span style="font-size:60px;"  id="precioTotal0"></span> </h2>
...
function cupon(texto){
  ...
  $.post('admin/ctrl/ctrlCupon.php', {
    ...
    if (response.length>10) { 
      ...
      $("#cuponOk").text("CupÃ³n aceptado, Tu anfitrion es "+responser['anfitrion']+" y brinda un descuento del "+responser['descuentoPorcentual']+"%");
      ...
      $("#cuponOkMovil").text("CupÃ³n aceptado,Tu anfitrion es "+responser['anfitrion']+" y brinda un descuento del "+responser['descuentoPorcentual']+"%");
     ...
     $("#cuponOk").text("CupÃ³n no vÃ¡lido.");
 ...
 $("#cuponOkMovil").text("CupÃ³n no vÃ¡lido.");
    ...
    $("#cuponOkMovil").addClass("text-danger");
     ...
     $("#cuponOk").addClass("text-danger");
          ...
          <div id="sidebar-calendar" class="d-md-block d-none">
                  ...
                  <div id="calendar" class="calendario-visitas cal1" translate="no"></div>
...
$serviciosRelacionados=getServiciosidDestino($idDestino);

if (1) { //count($serviciosRelacionados)>=3
...
<!--Finaliza esto -->
 ...
 <script type="text/javascript" src="js/traeHorarios.js?v=20251221g" charset="UTF-8"></script> 
 <script type="text/javascript" src="js/mejorasUI.js?v=20251221g" charset="UTF-8"></script> 
...
var dias = document.getElementsByClassName('day event');
...
for (var i = 0; i <  dias.length; i++) {
  ...
  traigoDiaPorClaseTMP=dias[i];



traigoDiaPorClaseTMP.style.color = "black";

traigoDiaPorClaseTMP.style.background = "#FFF";

traigoDiaPorClaseTMP.style.borderRadius = "0px";
      ...
      <div class="modal-body">
        ...
        <form class="form-buscar">
          ...
          <div class="input-group ">
            ...
            <input class="field form-control" id="buscar" name="buscar" type="text" placeholder="Â¿DÃ³nde vamos?" value="">
...
<!-- FIN MODAL BUSCAR MOVIL-->
 ...
 <!-- SCRIPTS NECESARIOS-->
  ...
  <script src="js/calendar-fix.js?v=<?php echo $version?>"></script>
