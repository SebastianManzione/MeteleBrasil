...
<a href="servicio?id=<?= $idServicio?>">
    ...
    <div class="card card-visitas">
        <div class="row no-gutters d-md-none" style="position: absolute;z-index: 999;">
                    ...
                    <div class="col-6">
                         <div class="badge badge-primary badge-destacado">¡Articulo Destacado!</div>
                    </div>
        </div>
...
<div class="row no-gutters d-md-none" style="position: absolute;z-index: 999;">
                    ...
                    <div class="col-6">
                         <div class="badge badge-primary badge-destacado">¡Destino recomendado!</div>
                    </div>
        </div>
...
<div class="row no-gutters d-md-none" style="position: absolute;z-index: 999;">
                    ...
                    <div class="col-6">
                         <div class="badge badge-primary badge-destacado">¡Mais Visitado!</div>
                    </div>
        </div>
