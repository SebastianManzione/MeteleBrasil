  ...
  <div class="container d-md-block">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="badge badge-primary badge-ciudad"><?=$lang["agencias_aperadores"]?></div>
         <!--FIN BUCLE DE LOS RESULTADOS AQUI-->
         
          <!--TITULO-->
        <h1 class="text-white texto-shadow py-2 bold" style=" text-shadow: -1px 0px 6px #000000;"><?=$lang["agencias_aperadores"]?></h1>
         <!--TITULO-->
  ...
  <div class="container container_r clearfix">
      <div class="row">
         ...
         <br>
            ...
            <p><?=$lang["ofrecer_un_paquete_turistico_o_actividad"];?></p>

            <h3><span class="py-4 text-primary"><?=$lang["que_son_los_operadores_mayoristas"]?></h3></span>

            
            <p><?=$lang["los_operadores_turisticos_mayoristas"]?></p>


            

            <h3><span class="py-4 text-primary"><?=$lang["como_trabaja_un_operador_mayorista"]?></h3></span>

            <p><?=$lang["los_operadores_mayoristas"]?></p>

            <p><?=$lang["los_operadores_minoristas"]?></p>
     ...
     <!-- ---------------------------------------------------------------------------------------------------------- -->
           ...
           <h3><span class="py-4 text-primary"><?=$lang["cual_es_la_diferencia"]?></span></h3>

            <p><?=$lang["el_operador_mayorista"]?></p>



            <li><?=$lang["la_principal_caracteristica_de_los_operadores"]?>

<br><br>



            <p><?=$lang["otros_factores_que_deben_tomar"]?></p>

                        <p><?=$lang["las_agencias_mayoristas"]?>


            <!-- ---------------------------------------------------------------------------------------------------------- -->

            <h3><span class="py-4 text-primary"><?=$lang["paquete_dinamico"]?></span></h3>

            <?=$lang["a_lo_largo_del_tiempo"]?>
            <br><br>



            <li><?=$lang["muchas_veces_no_entendemos"]?>
<br><br>

            <h3><span class="py-4 text-primary"><b><?=$lang["sumate_a_metele_brasil"]?></b></span></h3>
