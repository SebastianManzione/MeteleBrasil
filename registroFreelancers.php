...
if ($_SERVER["REQUEST_METHOD"] == "POST"  ) {
    // Validación anti-bot
    $validacion = validarAntiBot('register_freelancer_form', $_POST['recaptcha_token'] ?? null);
      ...
      <div class="col-lg-12">
        ...
        <div class="badge badge-primary badge-ciudad"></div>
         <!--FIN BUCLE DE LOS RESULTADOS AQUI-->
          ...
          <!--TITULO-->
        <h1 class="text-white texto-shadow py-2 bold" style=" text-shadow: -1px 0px 6px #000000; text-align:center;"><?=$lang["vendedor_externo"];?></h1>
         <!--TITULO-->
...
<div class="card card-primary" style="margin-left: 5%;margin-right: 5%;">
              <div class="card-header">
                ...
                <h3 class="card-title"><i class="fas fa-briefcase"></i><?=$lang["datos_vendedor_externo"];?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
          ...
          <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?=$lang["tipo_de_vendedor_externo"];?></label>
