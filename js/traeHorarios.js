...
if (salidas[i]["sinHorario"]==0) {
$('#divhora').append(

        '<button type="button" class="btn btn-light btn-block mt-2" onClick="traeTarifas('+salidas[i]["idServicioSalidas"]+')">'+salidas[i]["horaSalida"]+' '+salidas[i]["sinHorarioTexto"]+'</button>');
...
else if(salidas[0]["duracionMaxima"]<24 && salidas[0]["duracionMaxima"]>1){

  salidas[0]["duracionMaxima"]= (salidas[0]["duracionMaxima"])+" horas";
}
else{

   salidas[0]["duracionMaxima"] = (Math.round(salidas[0]["duracionMaxima"]*60))+" Minutos";
...
else if(salidas[0]["duracionMinima"]<24 && salidas[0]["duracionMinima"]>1){

  salidas[0]["duracionMinima"]= (salidas[0]["duracionMinima"])+" horas";
}
else{

   salidas[0]["duracionMinima"]= (Math.round(salidas[0]["duracionMinima"]*60))+" Minutos";
...
for (var k = 0; k < adicionalesNoIncluidos.length; k++) { //llenamos el acordeon de adicionales con los adicionales
  ...
  var lineaAdicionalesNoIncluidos='             <div class="row">'+
   ...
   '<span class="counter-label_span"><label id="txtPrecio">'+adicionalesNoIncluidos[k]['valor']+'</label></span>'+
...
' <a onclick="CalculaAdicionales('+adicionalesNoIncluidos[k]['idServicioSalidasAdicionales']+',1,0)"><i class="fa fa-plus-circle fa-2x"></i></a>'+
   ...
   '<span class="counter-label_span"><label id="txtPrecioCelular">'+adicionalesNoIncluidos[k]['valor']+'</label></span>'+
...
//console.log(tarifas[0]["adicionalesNoIncluidos"][k]);
  ...
  $('#ulNoIncluidos').append('<li>'+adicionalesNoIncluidos[k]["nombre"]+' '+adicionalesNoIncluidos[k]['valor']+'</li>');

   $('#ulNoIncluidosMovil').append('<li>'+adicionalesNoIncluidos[k]["nombre"]+' '+adicionalesNoIncluidos[k]['valor']+'</li>');
