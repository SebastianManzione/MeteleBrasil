...
<script>
  ...
  <title>Metele Brasil</title>
    ...
    <meta name="og:title"  content="Metele Brasil" />
...
<meta property="og:image" content="www.metelebrasil.com/img/og-image.png" />  
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
  ...
  <nav class="navbar navbar-expand-lg bg-celeste text-uppercase  d-none d-lg-block" id="mainNav">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index"><h1>METELE BRASIL</h1></a>
   ...
   <div class="col bg-white ">
             ...
             <div class="card card-usuario">
                ...
                <div class="row mb-4">
                  ...
                  </div><h5><?=$lang["no_tienes_cuenta"];?><span><?=$lang["registrate"];?> <b><?=$lang["aqui"];?></b></span></h5>
  ...
  <section class="bg-celeste ptb-10 d-lg-none">
 	...
 	<div class="container">
      ...
      <div class="col-5 text-center " >
          ...
          <a class="navbar-brand navbar-movil  " href="index.php"><h4 class="mb-0 text-white">METELE BRASIL</h4> </a>
