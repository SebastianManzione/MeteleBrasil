  ...
  <div class="container d-md-block d-none">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="badge badge-primary badge-ciudad"><?php echo PaisServicio($id); ?></div>
         <!--FIN BUCLE DE LOS RESULTADOS AQUI-->
         
          <!--TITULO-->
        <h1 class="text-white texto-shadow py-2 bold" style=" text-shadow: -1px 0px 6px #000000;"><?php echo NombreServicio($id); ?></h1>
         <!--TITULO-->
