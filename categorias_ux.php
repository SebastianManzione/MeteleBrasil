...
// Mismo setup que categorias.php pero sin paginación por GET
...
// Determine what to show (same logic as categorias.php)
$idCategoria = 0;
$busqueda = "";
...
if (isset($_GET["idCategoria"]) && $_GET['idCategoria'] > 0) {
    ...
    $opiniones_categoria = OpinionesCategoria($categorias[0]["idCategoria_servicio"]);
